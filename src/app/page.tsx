        ...
        <div className="max-w-6xl mx-auto pt-20 pb-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              Create professional, ATS-friendly resumes with intelligent
              suggestions for skills, achievements, and content. No external
              APIs required.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Get intelligent recommendations for skills, achievements, and
                bullet points tailored to your target role and experience level.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Choose from Professional, Executive, and Creative designs.
                Switch between templates anytime with real-time preview.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                All your data stays in your browser. No accounts required, no
                servers, no data collection. Export as PDF anytime.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                ensure your resume gets past automated screening.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                See your changes instantly with live preview. What you see is
                exactly what you&apos;ll get in the PDF export.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Visual indicators show your completion progress. Know exactly
                what sections need attention before exporting.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 flex items-start gap-6 hover:shadow-xl transition-shadow">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Use our intuitive section-based interface to add your personal
                  info, work experience, skills, projects, hobbies, and
                  references. Navigate easily between sections with visual
                  progress tracking.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 flex items-start gap-6 hover:shadow-xl transition-shadow">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Receive intelligent recommendations for missing skills,
                  impactful bullet points, and relevant hobbies based on your
                  target role and experience level. Apply suggestions with one
                  click.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 flex items-start gap-6 hover:shadow-xl transition-shadow">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Select from 3 professional templates, preview your resume in
                  real-time, and export as a high-quality PDF when you&apos;re
                  satisfied. Switch templates anytime without losing data.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-sm text-gray-500 mt-1">
                No AI APIs • Privacy First • Open Source Ready
              </p>
            </div>
          </div>
        </div>
